...
function updatePositions() {
  ...
  for (var i = 0; i < items.length; i++) {
    ...
    // I switched to Date.now() instead of scrollTop because it doesn't trigger layout
    //var phase = Math.sin(Date.now() + (i % 5));
    //var phase = Math.sin(Date.now());
